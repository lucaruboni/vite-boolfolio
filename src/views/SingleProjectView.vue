    ...
    <div v-if="project">
        ...
        <div class="my_row  bg_filter">
            <div class="container text-white">
                <div class="row row-cols-md row-cols-xl-1  pt-5 row-cols-sm-1 gap-4 ">
                
                   
                    <div class="col-8 img_container d-flex justify-content-center">
                        <img class="img-fluid" :src="getImageFromPath(project.cover_image)" alt="" >

            
                        
                   </div>
                    <div class="col-4 text_and_links d-flex flex-column gap-4 ps-5 mb-5">
                        <h1>{{ project.title }}</h1>
                        <p>{{  project.content }}</p>
